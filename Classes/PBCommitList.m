...
- (void)keyDown:(NSEvent *)event
{
	...
	if ((flags & NSEventModifierFlagShift) && (flags & NSEventModifierFlagCommand) && ([event keyCode] == 0x7E || [event keyCode] == 0x7D)) {
	...
	else if (([character characterAtIndex:0] == NSDownArrowFunctionKey) && (flags & NSEventModifierFlagControl)) {
